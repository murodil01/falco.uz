  ...
  return (
    <div className="py-[70px] max-w-[1260px] mx-auto px-4 md:px-6">
      <h3 className="text-center font-[700] text-[36px] sm:text-[50px] text-[#313131]">
        Sayohat <span className="text-[#9C8A5D]">Rejalari</span>
      </h3>

      <div className="flex flex-col lg:flex-row items-center md:justify-between gap-8 md:gap-[55px] mt-[60px] md:mt-[100px]">
        {/* Text Section */}
        <div className="flex flex-col gap-4 md:gap-[30px] md:w-1/2">
          <div className="flex items-center gap-5">
            <p className="bg-[#F3F2ED] text-[#09291B] text-[20px] sm:text-[22px] md:text-[24px] lg:text-[26px] font-[300] rounded-[50px] px-[25px] py-[5px]">
              Borishdan oldin bilib oling
            </p>
            <span className="text-[30px]">🌎</span>
          </div>
          <h3 className="font-[600] text-[28px] sm:text-[36px] text-[#313131]">
            Sayohat qilish xotiralar yaratishga
            <span className="text-[#9C8A5D]"> eshik ochadi</span>
          </h3>
