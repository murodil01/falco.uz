...
const Agree = ({ onContinue, onBack, formData, updateFormData }) => {
  const [form] = Form.useForm();
  const [formValues, setFormValues] = useState({
    team_failure: formData.team_failure || "",
  ...
  const handleSubmit = () => {
    form.validateFields()
      .then(values => {
        // Convert string to boolean for falco_core
        const falcoCore = values.falco_core === "yes";
        
        const formattedValues = {
          ...values,
          falco_core: falcoCore,
        };
